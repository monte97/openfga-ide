...
<template>
  <div class="fixed bottom-4 right-4 z-50 flex flex-col gap-2">
    <!-- Error toasts: assertive so screen readers announce immediately -->
    <div aria-live="assertive" aria-label="Error notifications">
      ...
      >
        <div
          v-for="toast in toasts.filter(t => t.type === 'error')"
          :key="toast.id"
          :class="[
    ...
    <!-- Non-error toasts: polite so screen readers finish current announcement -->
